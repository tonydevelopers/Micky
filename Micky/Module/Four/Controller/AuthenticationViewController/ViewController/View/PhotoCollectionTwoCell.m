...
@implementation PhotoCollectionTwoCell
@synthesize ID_imgV;
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [Gobal drawDottedBorder:ID_imgV borderColor:LINE_BORD_COLOR lineWidth:1.f lineDashInterval:@[@4,@3]];
        ...
        text_label.frame = CGRectMake(1, height-30, width-2, 20);
