...
@implementation APINetworkPrivate
...
+ (void)addDoNotBackupAttribute:(NSString *)path {
    ...
    if (error) {
        APILog(@"error to set do not backup attribute, error = %@", error);
    }
}
...
@implementation APIBaseRequest (RequestAccessory)

- (void)toggleAccessoriesWillStartCallBack {
    for (id<APIRequestAccessory> accessory in self.requestAccessories) {
...
@implementation APIBatchRequest (RequestAccessory)
...
@implementation APIChainRequest (RequestAccessory)
