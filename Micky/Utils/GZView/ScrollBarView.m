...
- (void) commonInit
{
    ...
    scrollDirection = SCROLLBAR_LEFT;
...
- (void) scroll
{
    ...
    if (scrollDirection == SCROLLBAR_LEFT){
        self.contentOffset = CGPointMake(0,0);
    }else if (scrollDirection == SCROLLBAR_RIGHT){
...
- (void) setScrollDirection: (enum ScrollBarDirection)direction
{
