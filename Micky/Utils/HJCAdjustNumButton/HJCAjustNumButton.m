...
- (void)commonSetup{
    ...
    _oneLine.frame = CGRectMake(viewH+5, 0, 1, viewH);
    _decreaseBtn.frame = CGRectMake(0+2.5, 0, viewH, viewH);
    _twoLine.frame = CGRectMake(viewW - viewH-5, 0, 1, viewH);
    _increaseBtn.frame = CGRectMake(viewW - viewH-2.5, 0, viewH, viewH);
