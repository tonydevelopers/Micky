...
@interface GraphicMixedView ()<UIWebViewDelegate>
...
//        CGFloat imageH = [self.text sizeWithFont:[UIFont systemFontOfSize:self.fontSize]].height- self.fontSize/4;
        CGFloat imageH = [self.text sizeWithAttributes:@{NSFontAttributeName : [UIFont systemFontOfSize:self.fontSize]}].height- self.fontSize/4;
