...
//{
//    if(self = [super init]){
//                nib =[[NSBundle mainBundle] loadNibNamed:@"ECPWebViewCtrl" owner:self options:nil];
//        
...
//     NSLog(@"%@",@"viewDidLoad");
    ...
    self.navigationItem.title= @"ECPay";
...
+(instancetype)getWebViewWithURL:(NSString * )url attributes:(NSDictionary *)attributes
{
    ...
    ECPWebViewCtrl *viewCtrl = [[ECPWebViewCtrl alloc] initWithAttributes:attributes];
...
{
    ECPWebViewCtrl *viewCtrl = [[self class] getWebViewWithURL:url attributes:attributes];
