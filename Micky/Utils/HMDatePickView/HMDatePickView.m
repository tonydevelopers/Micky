...
- (void)configuration {
    ...
    [formater setDateFormat:[_date_style length]>0?_date_style:@"yyyy-MM-dd"];
    ...
    if (self.maxYear) {
        ...
        NSString *maxStr;
        if ([_date_style length]>0) {
            maxStr= [NSString stringWithFormat:@"%ld-%@",maxYear,dateArray[1]];
        }else{
            maxStr= [NSString stringWithFormat:@"%ld-%@-%@",maxYear,dateArray[1],dateArray[2]];
        }
    ...
    if (self.minYear) {
        ...
        NSString *minStr;
        if ([_date_style length]>0) {
            minStr= [NSString stringWithFormat:@"%ld-%@",minYear,dateArray[1]];
        }else{
            minStr= [NSString stringWithFormat:@"%ld-%@-%@",minYear,dateArray[1],dateArray[2]];
        }
...
-(void)selectDate:(id)sender {
    ...
    [outputFormatter setDateFormat:[_date_style length]>0?_date_style:@"yyyy-MM-dd"];
