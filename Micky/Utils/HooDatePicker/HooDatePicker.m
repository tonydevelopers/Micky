...
// Constants times :
static CGFloat const kHooDatePickerAnimationDuration = 0.5f;
...
#define kHooDatePickerTintColor [UIColor colorWithRed:50.0/255.0 green:50.0/255.0 blue:50.0/255.0 alpha:1.0]

//#define kHooDatePickerHighlightColor [UIColor colorWithRed:255.0/255.0 green:180.0/255.0 blue:18.0/255.0 alpha:1.0]
#define kHooDatePickerHighlightColor [UIColor colorWithRed:252.0/255.0 green:128.0/255.0 blue:162.0/255.0 alpha:1.0]
...
- (instancetype)initWithSuperView:(UIView*)superView {
    ...
    if (self = [super initWithFrame:CGRectMake(0.0, superView.frame.size.height, superView.frame.size.width, kHooDatePickerHeight)]) {
        ...
        //        showView.frame = CGRectMake(0, 0, superView.frame.size.width, superView.frame.size.height);
        ...
        //        [showView addSubview:self.headerView];
        [self setupControl];
    }
    return self;
}
...
-(void)show {
    ...
    show_backGround_view = [[UIView alloc]init];
    show_backGround_view.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
    show_backGround_view.backgroundColor = [UIColor colorWithWhite:0 alpha:0.3];
    [_dimBackgroundView addSubview:show_backGround_view];
    ...
    [UIView animateWithDuration:kHooDatePickerAnimationDuration delay:0.0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
        show_backGround_view.alpha = 1.0;
...
-(void)dismiss {
    ...
    [UIView animateWithDuration:kHooDatePickerAnimationDuration delay:0.0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
        self.frame = CGRectMake(self.frame.origin.x, _superView.frame.size.height, self.frame.size.width, self.frame.size.height);
        show_backGround_view.alpha = 0.0;
        self.dimBackgroundView.alpha = 0.0;
    } completion:^(BOOL finished) {
        _isOpen = NO;
        [show_backGround_view removeFromSuperview];
        show_backGround_view = nil;
